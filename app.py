...
class_labels = [
    ...
    'Curry Leaf', 'Tulasi', 'Ekka', 'Ganike', 'Guava', 'Geranium',
    'Henna', 'Hiibiscus', 'Honge', 'Insulin', 'Epipremnumaureum - money plant', 'Lemon', 'Lemon Grass',
    'Mango', 'Mint', 'Nagadali', 'Neem', 'Nithyapushpa', 'Nooni', 'Peepal',
    'Pepper', 'Pomegranate', 'Raktachandini', 'Hibiscus', 'Sapota', 'Tulasi',
    'Wood Sorel'
]
...
# Home Page
if app_mode == "Home":
    st.title("Welcome to EcoMed")
    st.image("images/homepage.jpg", use_container_width=True)

    st.markdown("""
    **EcoMed** offers a powerful solution for identifying medicinal plants and detecting plant diseases using advanced machine learning techniques.
